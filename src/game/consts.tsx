...
const players: Player[] = [
  {
    name: 'תומר',
    text:
      'אני בן 10 בכיתה ה, ואני אוהב פיצה, כדורגל ולרוץ עם חברים. לפני שנתיים, רכבתי באופניים בנתיב לא מתאים ורכב פגע לי ברגל הרופאים קטעו לי את רגל שמאל מעל הברך וגיליתי, לשמחתי, שעם פרוטזה (התותבת מהמתכת שמחוברת לרגלי השמאלית) אני יכול לעשות כמעט הכל.',
    path: 'tomer',
    images: {
      hello: [Tomer],
  ...
  },
  {
    name: 'ניר',
    text:
      'אני בן 9, לומד בכיתה ד, ואני אוהב ממתקים, לצאת לטייל עם הכלב שלי ולשחק כדורסל עם חברים. כשהייתי בבטן של אימי, הגוף שלי לא התפתח כמו שצריך, חמצן לא הגיע לאזור שפוקד על הרגליים לזוז (זה נקרא שיתוק מוחין), ולכן קשה לי ללכת. אני מתנייד עם כיסא גלגלים. הכיסא מאפשר לי להתחרות עם חברים ולהגיע במהירות ממקום למקום.',
    path: 'nir',
    images: {
      hello: [Nir],
  ...
  },
  {
    name: 'שירה',
    text:
      'אני בת 11, לומדת בכיתה ו ואני ממש אוהבת להיפגש עם חברות, ולעשות סרטונים בטיקטוק. יש לי בעית ראייה שעוברת במשפחה (יש אותה גם לאבא שלי) בה אני רואה דברים במטושטש. אני נעזרת במקל הליכה, בחברות שלי ובחוש השמיעה שלי המפותח שלי.',
    path: 'shira',
    images: {
      hello: [Shira],
    ...
    actions: [
      ...
      { able: 'CAN', action: 'לשחק כדורגל', id: 3, position: 'INIT', info: 'יש כדור מיוחד שמשמיע צליל' },
      { able: 'CANT', action: 'לראות את דגל ישראל על מדי הנבחרת', id: 4, position: 'INIT', info: '' },
      { able: 'CAN', action: 'לגלוש סקי', id: 5, position: 'INIT', info: '' },
