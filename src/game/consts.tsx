...
const players: Player[] = [
  ...
  },
  {
    ...
    actions: [
      { able: 'CAN', action: 'לנסוע באוטובוס לאימון', id: 1, position: 'INIT', info: 'בדיקה' },
      {
        able: 'CANT',
        action: 'לא לנסוע באוטובוס לאימון',
        id: 2,
        position: 'INIT',
        info: 'בדיקה לטקסט ארוך מאוד שאולי ייכנס',
      },
      { able: 'CANT', action: 'לא לעשות כלים', id: 3, position: 'INIT', info: 'בדיקה לטקסט ארוך מאוד שאולי ייכנס' },
      { able: 'CAN', action: 'לעשות כלים', id: 4, position: 'INIT', info: '' },
      { able: 'CANT', action: 'לא לרוץ מהר מאוד', id: 5, position: 'INIT', info: 'בדיקה לטקסט ארוך מאוד שאולי ייכנס' },
      { able: 'CAN', action: 'לרוץ מהר מאוד', id: 6, position: 'INIT', info: '' },
      {
        able: 'CANT',
        action: 'לא לקפוץ על רגל אחת',
        id: 7,
        position: 'INIT',
        info: 'בדיקה לטקסט ארוך מאוד שאולי ייכנס',
      },
