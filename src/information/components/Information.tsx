      ...
      <MainWrapper>
        <Main>
          <StyledSection>
            ...
            <P>
              ההתאחדות הישראלית לספורט נכים אמונה על ניהולם של עשרים ענפי ספורט פראלימפים ומנהלת בהם את כל פעילות הספורט
              התחרותית וההישגית של ספורט הנכים בישראל.
            </P>
          </StyledSection>
          <StyledSection>
            <H5>הוועד הפראלימפי הישראלי</H5>
            <P>
              הוועד הפראלימפי הישראלי אחראי להכנתן ושיגורן של משלחות ישראל למשחקים הפראלימפים. הוועד הפראלימפי תומך
              בספורטאי הסגלים ונתמך במישור המקצועי על ידי היחידה לספורט הישגי.
              <br />
              הוועד הפראלימפי מפעיל את הקרן לקידום ספורט הנכים, מעניק מלגות הישג לספורטאי הסגל הבכיר בהתאם לקריטריוני
              הישג מזכים, ומלווה בתמיכה מקצועית ספורטאי עתודה מצטיינים וסגל 2020.
            </P>
          </StyledSection>
          <StyledSection>
